...
export function renderWebGLFallback(message?: string): void {
  ...
  app.innerHTML = `
    <div class="fallback-shell">
      <div class="fallback-card">
        ...
        <h1>Sweet Land is taking a breather</h1>
        <p class="fallback-copy">
          ${message ?? "This device couldn’t start the Candy Castle scene cleanly, but you can still explore Chloe’s world from here."}
        </p>
